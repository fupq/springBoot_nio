...
public class AES {
	...
	/**
	 * getRandom:生成长度为length的由字母（大小写）0-9的数字组成的字符串
...
//	 */
	...
	/**
	 * encryptToBase64:用key对数据data进行加密
	 * 
	 * @author xn042142 fupinxin
	 * @param data 被加密的数据
	 * @param key 加密密码
	 * @return 加密后的字符串
	 * @since JDK 1.8
	...
	public static String encryptToBase64(String data, String key){
		try {
			...
			throw new RuntimeException("使用随机密码对data加密失败!", e);
		}
		
	}
	
	/**
	 * decryptFromBase64:用key对data进行解密 <br/> 
	 * TODO(杩欓噷鎻忚堪杩欎釜鏂规硶鐨勬敞鎰忎簨椤� 鈥� 鍙��).<br/> 
	 * 
	 * @author xn042142 浠樺搧娆�
	...
	public static String decryptFromBase64(String data, String key){
		try {
			...
			throw new RuntimeException("使用随机密码对data解密失败!", e);
		}
	}
	...
	public static String encryptWithKeyBase64(String data, String key){
		try {
			...
			throw new RuntimeException("随机密码对data加密失败!", e);
		}
	}
